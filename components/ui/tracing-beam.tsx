...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 hidden md:block" style={{ marginLeft: '-80px' }}>
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
          ...
          className="border-neutral-200 ml-[27px] flex h-4 w-4 items-center justify-center rounded-full border shadow-sm bg-white"
